...
Mobile.startExistingApplication('com.lenddo.mobile.paylater.staging')

Mobile.tap(findTestObject('Object Repository/View transactions/android.widget.TextView - Home'), 0)

Mobile.pressBack()

Mobile.swipe(0, 10, 0, 50)

Mobile.scrollToText('VIEW ALL')

Mobile.tap(findTestObject('Object Repository/View transactions/android.widget.TextView - VIEW ALL'), 0)

Mobile.tap(findTestObject('Object Repository/View transactions/android.widget.TextView - Incoming'), 0)
